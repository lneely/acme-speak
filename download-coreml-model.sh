...
case "$script_path" in
    */bin) default_download_path="$PWD/models" ;;  # Use current directory as default download path if in /bin/
    *) default_download_path="$script_path/models" ;;  # Otherwise, use script directory
esac
